...
def parse_args():
    ...
    parser.add_argument("--src_json",
                        default="/13994058190/WYH/UNINEXT/datasets/VQAv2/v2_mscoco_val2014_annotations.json", type=str,
    ...
    for split in data.keys():
        if split == "annotations":
            ...
            for cur_data in data[split]:
                inst_idx += 1
                image = {"file_name": "COCO_val2014_%012d.jpg" % cur_data["image_id"], "height": 420, "width": 420, \
                         "id": inst_idx}
                image["expressions"] = []
