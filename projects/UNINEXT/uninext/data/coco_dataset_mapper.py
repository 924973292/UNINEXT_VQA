...
class DetrDatasetMapper:
    ...
    def __init__(self, cfg, is_train=True, test_categories=None):
        ...
        if self.lang_guide_det:
            ...
            if use_roberta:
                self.tokenizer = RobertaTokenizerFast.from_pretrained('/13994058190/WYH/UNINEXT/projects/UNINEXT/roberta-base')
            else:
                self.tokenizer = AutoTokenizer.from_pretrained('/13994058190/WYH/UNINEXT/projects/UNINEXT/bert-base-uncased') # align with GLIP
