...
_PREDEFINED_SPLITS_REFCOCO = {
    ...
    "refcoco-unc-show": ("coco/train2014", "annotations/refcoco-unc/instances_show.json"),
    # refcocog
    ...
    "refcocog-umd-show": ("coco/train2014", "annotations/refcocog-umd/instances_show.json"),
    # refcoco+
    ...
    "refcocoplus-unc-show": ("coco/train2014", "annotations/refcocoplus-unc/instances_show.json"),
    # referit
    "referitgame-berkeley-train": ("saiaprtc12", "annotations/referitgame-berkeley/instances_train.json"),
    "referitgame-berkeley-val": ("saiaprtc12", "annotations/referitgame-berkeley/instances_val.json"),
    "referitgame-berkeley-test": ("saiaprtc12", "annotations/referitgame-berkeley/instances_test.json"),
    "referitgame-berkeley-show": ("saiaprtc12", "annotations/referitgame-berkeley/instances_show.json"),
    # mixed
...
# ==== Predefined splits for vqa datasets ===========
_PREDEFINED_SPLITS_VQA = {
    # vqa
    "vqa-train": ("VQAv2/train2014", "VQAv2/v2_mscoco_train2014_annotations_annotations.json"),
    "vqa-val": ("VQAv2/val2014", "VQAv2/v2_mscoco_val2014_annotations_annotations.json"),
    "vqa-test-show": ("VQAv2/test2015", "VQAv2/v2_OpenEnded_mscoco_test2015_questions_show.json"),
    "vqa-train-show": ("VQAv2/train2014", "VQAv2/v2_mscoco_train2014_annotations_show.json"),
    "vqa-val-show": ("VQAv2/val2014", "VQAv2/v2_mscoco_val2014_annotations_show.json"),
    # vg
    "vg-train": ("VG/VG_100K", "VG/question_answers_train.json"),
}

def register_all_vqa(root):
    for key, (image_root, json_file) in _PREDEFINED_SPLITS_VQA.items():
        # Assume pre-defined datasets live in `./datasets`.
        register_refcoco(
            key,
            _get_refcoco_meta(),
...
_PREDEFINED_SPLITS_REFYTBVOS = {
    ...
    "rvos-a2d-train": ("a2d_sentences/Release/clips320H", "a2d_sentences/instances_train.json"),
    "rvos-a2d-val": ("a2d_sentences/Release/clips320H", "a2d_sentences/instances_val.json"),
}
