    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if task in ["detection", "grounding"]:
                ...
                output, loss_dict,visual_cash,language_cash = self.detr.coco_forward_vis(images, det_targets, ref_targets, self.criterion, train=True, language_dict_features=language_dict_features, task=task)
